...
function MapLeaflet({ center = [-23.5505, -46.6333], zoom = 13, height = "30vh" }) {
    ...
    return (
        <div style={{ position: "relative", width: "100%", height }}>
            ...
            <div
                ref={mapRef}
                id="map-container"
                style={{ width: "100%", height: "100%", borderRadius: "1rem", opacity: mapLoaded ? 1 : 0, transition: "opacity 0.3s" }}
            />
        </div>
    );
}
